...
export function ProjectCard({
  ...
  return (
    <Link
      href={`/proyectos/${slug}`}
      className="group block rounded-lg border border-background bg-surface p-4 transition hover:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
    >
      <div className="relative mb-5 h-56 overflow-hidden rounded-lg bg-secondary">
        ...
        <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-4 text-primary">
          <span className="rounded bg-background px-3 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-primary">
            Obra
          </span>
